settingsSchemaObject = {
  ...
  siteUrl: {
    ...
    autoform: {
      group: 'general',
      instructions: ''
      // Your site\'s URL (with trailing "/"). Will default to Meteor.absoluteUrl()
    }
  },
  tagline: {
    type: String,
  ...
  defaultEmail: {
    ...
    autoform: {
      group: 'email',
      instructions: 'Vanaf deze email worden alle emails verzonden',
      private: true
    }
  },
  mailUrl: {
    ...
    autoform: {
      group: 'email',
      instructions: 'MAIL_URL environment variable (restart verplicht).',
      private: true
    }
  },
  scoreUpdateInterval: {
  ...
  postInterval: {
    ...
    autoform: {
      group: 'posts',
      instructions: 'Minimale tijd tuusen het plaaten van een project, in secondes (nomraal 30)'
    }
  },
  commentInterval: {
    type: Number,
